...
#-------------------------------
apt-get update
apt-get install -y libgtk2.0-dev curl libcurl4-gnutls-dev libfreetype6-devl pkg-config fop zip
...
then
   cd /Downloads
   wget http://1.0.0.17:/data3/software/cmake/cmake-3.5.2-precise-amd64.tar.gz
