...
cd /Downloads
scp -o StrictHostKeyChecking=no root@1.0.0.17:/data3/software/R/RInside_0.2.10.tar.gz .
...
then
   cd /Downloads
   wget http://1.0.0.17:/data3/software/cmake/cmake-3.5.2-precise-i686.tar.gz
